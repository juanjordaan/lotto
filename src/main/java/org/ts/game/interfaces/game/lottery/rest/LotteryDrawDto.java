...
public class LotteryDrawDto extends DrawDto<LotteryGameDto> {
	...
	public String toString() {
		return "LotteryDrawDto [ball1=" + ball1 + ", ball2=" + ball2 + ", ball3=" + ball3 + ", ball4=" + ball4
				+ ", ball5=" + ball5 + ", ball6=" + ball6 + ", ball7=" + ball7 + ", getDate()=" + getDate()
				+ ", getGame()=" + getGame() + ", getId()=" + getId() + ", getVersion()=" + getVersion() + "]";
	}
}
